# Generated by Django 2.1 on 2019-06-25 14:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('storagedevice', '存储设备'), ('networkdevice', '网络设备'), ('securitydevice', '安全设备'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('m_day', models.DateField(auto_now_add=True, verbose_name='更新日期')),
            ],
            options={
                'verbose_name': '合同',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufactory', models.CharField(blank=True, max_length=128, null=True, verbose_name='硬盘制造商')),
                ('slot', models.CharField(max_length=128, verbose_name='插槽位')),
                ('capacity', models.IntegerField(blank=True, null=True, verbose_name='磁盘容量(GB)')),
                ('interface_type', models.CharField(choices=[('SATA', 'SATA'), ('SAS', 'SAS'), ('SCSI', 'SCSI'), ('SSD', 'SSD'), ('unknown', 'unknown')], max_length=16, verbose_name='接口类型')),
                ('assets', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '硬盘',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.SmallIntegerField(choices=[(0, '其他'), (1, '硬件变更'), (2, '新增配件'), (3, '设备下线'), (4, '设备上线'), (5, '定期维护'), (6, '业务上线/变更/更新')], default=4, verbose_name='设备类型')),
                ('component', models.TextField(blank=True, max_length=256, null=True, verbose_name='事件子项')),
                ('detail', models.TextField(verbose_name='事件详情')),
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='事件时间')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('assets', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '事件记录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.CharField(blank=True, max_length=128, null=True, verbose_name='机房名称')),
            ],
            options={
                'verbose_name': '机房',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '路由器'), (1, '交换机'), (2, '负载均衡'), (3, '运维审计系统')], default=0, verbose_name='网络设备类型')),
                ...
                ('assets', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '网络设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufactory', models.CharField(blank=True, max_length=128, null=True, verbose_name='内存制造商')),
                ('slot', models.CharField(max_length=128, verbose_name='插槽位')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '塔式'), (1, '机架式'), (2, '刀片式'), (3, '小型机')], default=0, verbose_name='服务器类型')),
                ...
                ('os_distribution', models.CharField(blank=True, max_length=64, null=True, verbose_name='操作系统发行商')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '磁盘阵列'), (1, '网络存储器'), (2, '磁盘库'), (3, '磁带机')], default=0, verbose_name='存储设备类型')),
